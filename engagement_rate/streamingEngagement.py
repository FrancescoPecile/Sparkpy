...
class ForeachWriter:
    ...
    def open(self, partition_id, epoch_id):
        ...
        self.db = self.connection['Engagement']
        self.coll = self.db['EngStream']
        print(epoch_id)
        print(partition_id)
        return True
